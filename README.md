...
<img src="assets/title.svg" width="100%" alt="TREBADRIPAT — a nikos3rd adventure. Press start." />

<img src="assets/dialogue.svg" width="100%" alt="Nikos: Hi. I build autonomous AI agents, LangGraph DAGs, 3D web and local-first computer vision." />

<img src="assets/charsheet.svg" width="100%" alt="Character sheet: level, HP, MP, XP and skill stats. Refreshed daily from GitHub." />

<img src="assets/inventory.svg" width="100%" alt="Inventory: Python, TypeScript, LangGraph, MCP, FastAPI, Next.js, Three/R3F, Tailwind, Postgres, MongoDB, Docker, Terraform, OpenCV, Playwright, Git, Linux" />
...
<img src="assets/worldmap.svg" width="100%" alt="World map: last 53 weeks of commits drawn as overworld tiles. Refreshed daily." />
...
<sub>Screens are hand-drawn SVG on the DMG palette. Character sheet and world map are rebuilt every night by <a href=".github/workflows/update-profile.yml">a GitHub Action</a>. Font: Press Start 2P (OFL).</sub>
